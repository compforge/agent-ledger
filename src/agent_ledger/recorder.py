...
class SessionRecorder:
    """Framework-facing recorder that serializes writes to one run stream."""
    ...
    async def resume(
        ...
        *,
        ...
        stream = RunStream(session_id=session_id, run_id=run_id)
        expected_version = -1
        parent_run_id: str | None = None
        caused_by_event_id: str | None = None
    ...
    def child(
        ...
        *,
        ...
        return SessionRecorder(
            ...
            run_id=run_id,
            actor=actor,
            parent_run_id=self.stream.run_id,
            caused_by_event_id=caused_by_event_id,
        )
